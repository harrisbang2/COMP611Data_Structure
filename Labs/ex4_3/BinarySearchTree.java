   ...
   implements SortedSet<E>
{
   ...
   {  return "Tree:" + rootNode;
    ...
    public void leftRotationOfroot() {
     ...
     BinaryTreeNode childStore;
     helper = rootNode.rightChild;
     childStore= helper.leftChild;
     helper.leftChild =rootNode;
     rootNode.rightChild=childStore;
     rootNode =helper;
    }
    public void rightRotationOfroot() {
     BinaryTreeNode helper;
     BinaryTreeNode childStore;
     helper = rootNode.leftChild;
     childStore= helper.rightChild;
     helper.rightChild =rootNode;
     rootNode.leftChild=childStore;
     rootNode =helper;
    }
